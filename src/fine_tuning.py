...
def objective(trial: optuna.Trial) -> float:
    ...
    executor = optuna.integration.allennlp.AllenNLPExecutor(
        ...
        config_file="experiments/configs/optuna_boe_100_avg.jsonnet",  # jsonnet path
        serialization_dir=f"experiments/optuna/{trial.number}",  # directory for snapshots and logs
